...
std::vector<AuthoringCapability> defaultAuthoringCapabilities()
{
    ...
    return {
        ...
        makeCapability(
            ...
            {example("Create a cube entity.", R"({ "op": "primitive", "alias": "Player", "mesh": "Cube" })")}),
        makeCapability(
            "parent",
            "Parent Entity",
            ...
            {example("Parent a mesh under a root.", R"({ "op": "parent", "child": "Body", "parent": "Root" })")}),
        ...
        makeCapability(
            ...
            {example("Rename an entity.", R"({ "op": "name", "entity": "Player", "name": "Player Character" })")}),
        makeCapability(
            "transform",
            "Set Transform",
        ...
        makeCapability(
            ...
            {example("Set a light intensity.", R"({ "op": "light-intensity", "entity": "KeyLight", "value": 3.5 })")}),
        ...
        makeCapability(
            ...
            {example(
                "Configure an orthographic camera.",
        ...
        makeCapability(
            ...
            {
                param("target", Type::String, "Inspection target.", true, {"scene", "entity", "hierarchy"}),
            ...
            },
            {
                ...
                example("Inspect an entity.", R"({ "op": "inspect", "target": "entity", "entity": "Player" })"),
            }),
        makeCapability(
            "verify",
