...
void PipelineResources::updateSceneBindings(const RHI::Ref<RHI::Texture>& environment_texture,
...
void PipelineResources::updateTransparentCompositeResources(const RHI::Ref<RHI::Texture>& transparent_color)
{
