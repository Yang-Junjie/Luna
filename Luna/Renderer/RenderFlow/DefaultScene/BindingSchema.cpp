...
const std::array<DescriptorBindingSchema, 15> kMaterialBindings{{
    {"BaseColorTexture",
    ...
    {"MetallicTexture",
     material_binding::MetallicTexture,
     RHI::DescriptorType::SampledImage,
     1,
     kFragmentStage,
     "gMetallicTexture"},
    {"MetallicSampler",
     material_binding::MetallicSampler,
     RHI::DescriptorType::Sampler,
     1,
     kFragmentStage,
     "gMetallicSampler"},
    {"RoughnessTexture",
     material_binding::RoughnessTexture,
     RHI::DescriptorType::SampledImage,
     1,
     kFragmentStage,
     "gRoughnessTexture"},
    {"RoughnessSampler",
     material_binding::RoughnessSampler,
     RHI::DescriptorType::Sampler,
     1,
     kFragmentStage,
     "gRoughnessSampler"},
