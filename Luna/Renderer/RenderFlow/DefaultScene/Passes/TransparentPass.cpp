...
void TransparentPass::setup(RenderPassContext& context)
{
    ...
    blackboard::publishSceneColorStage(
        context.blackboard(), blackboard::SceneColorStage::TransparentComposited, scene_color);
    ...
    context.graph().AddRasterPass(
        ...
        [scene_context, transparent_color](RenderGraphRasterPassBuilder& pass_builder) {
            ...
            pass_builder.WriteColor(
                scene_context.pick_target, RHI::AttachmentLoadOp::Load, RHI::AttachmentStoreOp::Store);
            pass_builder.WriteDepth(
                scene_context.depth_target, RHI::AttachmentLoadOp::Load, RHI::AttachmentStoreOp::Store);
        },
