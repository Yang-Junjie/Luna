...
namespace Cacao
{
        ...
        : m_createInfo(info)
    {
        ...
        {
        case PresentMode::Immediate: config.presentMode = WGPUPresentMode_Immediate; break;
        case PresentMode::Mailbox:   config.presentMode = WGPUPresentMode_Mailbox; break;
        case PresentMode::Fifo:      config.presentMode = WGPUPresentMode_Fifo; break;
    ...
    Extent2D WGPUSwapchain::GetExtent() const { return m_createInfo.Extent; }
    Format WGPUSwapchain::GetFormat() const { return m_createInfo.Format; }
    PresentMode WGPUSwapchain::GetPresentMode() const { return m_createInfo.PresentMode; }
    uint32_t WGPUSwapchain::GetImageCount() const { return m_imageCount; }
