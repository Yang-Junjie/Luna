...
namespace Cacao
{
    ...
    AdapterProperties WGPUAdapter::GetProperties() const
    {
        ...
        {
        case WGPUAdapterType_DiscreteGPU:   result.type = AdapterType::Discrete; break;
        case WGPUAdapterType_IntegratedGPU: result.type = AdapterType::Integrated; break;
        case WGPUAdapterType_CPU:           result.type = AdapterType::Software; break;
        default:                            result.type = AdapterType::Unknown; break;
        }
        return result;
    }
