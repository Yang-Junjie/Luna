...
namespace Cacao
{
    WGPUGraphicsPipeline::WGPUGraphicsPipeline(const Ref<Device>& device,
                                                const GraphicsPipelineCreateInfo& info)
        : m_layout(info.Layout), m_createInfo(info)
    {
        ...
        if (vsModule) vertexState.module = vsModule;
        ...
        if (hasDepthStencil)
        {
            ...
            depthStencilState.stencilFront.compare = info.DepthStencil.StencilTestEnable
                ? ToWGPUCompareFunction(info.DepthStencil.Front.CompareOp) : WGPUCompareFunction_Always;
            ...
            depthStencilState.stencilBack.compare = info.DepthStencil.StencilTestEnable
                ? ToWGPUCompareFunction(info.DepthStencil.Back.CompareOp) : WGPUCompareFunction_Always;
    ...
    WGPUComputePipelineImpl::WGPUComputePipelineImpl(const Ref<Device>& device,
