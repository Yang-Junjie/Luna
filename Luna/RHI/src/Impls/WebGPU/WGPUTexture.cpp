...
uint32_t WGPUTextureImpl::GetWidth() const
{
    return m_createInfo.Width;
}

uint32_t WGPUTextureImpl::GetHeight() const
{
    return m_createInfo.Height;
}

uint32_t WGPUTextureImpl::GetDepth() const
{
    return m_createInfo.Depth;
}

uint32_t WGPUTextureImpl::GetMipLevels() const
{
    return m_createInfo.MipLevels;
}

uint32_t WGPUTextureImpl::GetArrayLayers() const
{
    return m_createInfo.ArrayLayers;
}

Format WGPUTextureImpl::GetFormat() const
{
    return m_createInfo.Format;
}

TextureType WGPUTextureImpl::GetType() const
{
    return m_createInfo.Type;
}

SampleCount WGPUTextureImpl::GetSampleCount() const
{
    return m_createInfo.SampleCount;
}

TextureUsageFlags WGPUTextureImpl::GetUsage() const
{
    return m_createInfo.Usage;
}

ResourceState WGPUTextureImpl::GetCurrentState() const
{
