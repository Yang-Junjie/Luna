...
namespace Cacao
{
        ...
        : m_device(device), m_createInfo(info)
    {
            ...
            for (const auto& binding : d3dLayout->GetBindings())
            {
                ...
                else
                {
                    ...
                    case DescriptorType::UniformBufferDynamic:
                        range.RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_CBV; break;
                    case DescriptorType::StorageImage:
                        range.RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_UAV; break;
                    default:
                        range.RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_SRV; break;
                    }
        ...
        fprintf(stderr, "D3D12PipelineLayout: %zu root params, %zu set layouts\n",
        ...
        {
            hr = d3dDevice->GetHandle()->CreateRootSignature(0, signatureBlob->GetBufferPointer(),
    ...
    Ref<D3D12PipelineLayout> D3D12PipelineLayout::Create(const Ref<Device>& device,
