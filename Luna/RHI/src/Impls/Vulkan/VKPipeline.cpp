...
namespace Cacao
{
    static void ConvertShaderStages(
        std::span<const Ref<ShaderModule>> shaderModules,
    ...
    static vk::PipelineRenderingCreateInfo ConvertPipelineRenderingCreateInfo(
        std::span<const vk::Format> colorAttachmentFormats,
    ...
    VKComputePipeline::VKComputePipeline(const Ref<Device>& device,
    ...
    Ref<VKComputePipeline> VKComputePipeline::Create(const Ref<Device>& device,
                                                     const ComputePipelineCreateInfo& createInfo)
    {
