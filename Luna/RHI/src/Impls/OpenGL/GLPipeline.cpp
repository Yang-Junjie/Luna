...
namespace Cacao
{
    ...
    GLGraphicsPipeline::GLGraphicsPipeline(const GraphicsPipelineCreateInfo& info)
    {
        ...
        if (info.Rasterizer.CullMode != CullMode::None)
        {
            ...
            {
            case CullMode::Front: m_state.cullMode = GL_FRONT; break;
            case CullMode::Back:  m_state.cullMode = GL_BACK; break;
            case CullMode::FrontAndBack: m_state.cullMode = GL_FRONT_AND_BACK; break;
            default: m_state.cullMode = GL_BACK; break;
            }
        }
        m_state.frontFace = (info.Rasterizer.FrontFace == FrontFace::CounterClockwise)
            ? GL_CCW : GL_CW;
    }
    ...
    void GLGraphicsPipeline::Bind() const
    {
        ...
        {
            glEnable(GL_BLEND);
            glBlendFuncSeparate(m_state.blendSrcRGB, m_state.blendDstRGB,
