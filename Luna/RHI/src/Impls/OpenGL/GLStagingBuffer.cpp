...
namespace Cacao
{
        ...
        : m_capacity(capacity)
    {
        ...
        glBufferStorage(GL_COPY_READ_BUFFER, static_cast<GLsizeiptr>(capacity), nullptr,
                        flags | GL_DYNAMIC_STORAGE_BIT);
        m_mappedPtr = glMapBufferRange(GL_COPY_READ_BUFFER, 0,
                                        static_cast<GLsizeiptr>(capacity), flags);
        #else
