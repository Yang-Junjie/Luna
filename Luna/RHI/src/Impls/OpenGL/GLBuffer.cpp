...
namespace Cacao
{
        ...
        : m_device(device), m_createInfo(info)
    {
        ...
        bool isMappable = (info.MemoryUsage == BufferMemoryUsage::CpuToGpu ||
                           info.MemoryUsage == BufferMemoryUsage::GpuToCpu);
    ...
    uint64_t GLBuffer::GetSize() const { return m_createInfo.Size; }
    BufferUsageFlags GLBuffer::GetUsage() const { return m_createInfo.Usage; }
    BufferMemoryUsage GLBuffer::GetMemoryUsage() const { return m_createInfo.MemoryUsage; }
