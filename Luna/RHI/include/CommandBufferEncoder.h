...
namespace Cacao
{
    ...
    public:
        ...
        virtual void BindVertexBuffer(uint32_t binding, const Ref<Buffer>& buffer,
                                      uint64_t offset = 0) = 0;
        virtual void BindIndexBuffer(const Ref<Buffer>& buffer, uint64_t offset,
        ...
        virtual void TransitionImage(
            ...
            const ImageSubresourceRange& range = {0, 1, 0, 1, ImageAspectFlags::Color}
        ) = 0;
