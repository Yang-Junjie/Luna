...
public:
    VKGraphicsPipeline(const Ref<Device>& device, const GraphicsPipelineCreateInfo& createInfo);
    ~VKGraphicsPipeline() override;
    static Ref<VKGraphicsPipeline> Create(const Ref<Device>& device, const GraphicsPipelineCreateInfo& createInfo);
...
public:
    ...
    static Ref<VKComputePipeline> Create(const Ref<Device>& device, const ComputePipelineCreateInfo& createInfo);
    Ref<PipelineLayout> GetLayout() const override;
