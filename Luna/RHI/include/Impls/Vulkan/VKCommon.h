...
namespace Cacao
{
    ...
    namespace VKResourceStateConvert
    {
        ...
        inline VkImageLayout GetLayout(ResourceState state) noexcept { return Convert(state).layout; }
        inline VkPipelineStageFlags GetStage(ResourceState state) noexcept { return Convert(state).stage; }
        inline VkAccessFlags GetAccess(ResourceState state) noexcept { return Convert(state).access; }
    }
