...
namespace Cacao
{
    ...
    public:
        ...
        uint64_t GetSize() const override { return m_createInfo.Size; }
        BufferUsageFlags GetUsage() const override { return m_createInfo.Usage; }
        BufferMemoryUsage GetMemoryUsage() const override { return m_createInfo.MemoryUsage; }
        uint64_t GetDeviceAddress() const override { return 0; }

        id GetHandle() const { return m_buffer; }
