...
namespace Cacao
{
    ...
    public:
        ...
        id GetHandle() const { return m_view; }
    ...
    public:
        ...
        uint32_t GetDepth() const override { return m_createInfo.Depth; }
        Format GetFormat() const override { return m_createInfo.Format; }
        uint32_t GetMipLevels() const override { return m_createInfo.MipLevels; }
        uint32_t GetArrayLayers() const override { return m_createInfo.ArrayLayers; }
        TextureType GetType() const override { return m_createInfo.Type; }
        SampleCount GetSampleCount() const override { return m_createInfo.SampleCount; }
        TextureUsageFlags GetUsage() const override { return m_createInfo.Usage; }
        ...
        id GetHandle() const { return m_texture; }
