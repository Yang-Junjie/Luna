...
namespace Cacao
{
    ...
    {
    public:
        MTLDescriptorSetLayout(const DescriptorSetLayoutCreateInfo& info) : m_info(info) {}
        ~MTLDescriptorSetLayout() override = default;
        const DescriptorSetLayoutCreateInfo& GetCreateInfo() const override { return m_info; }
    private:
    ...
    {
    public:
        MTLDescriptorPool(const DescriptorPoolCreateInfo& info) : m_info(info) {}
    ...
    {
    public:
        MTLDescriptorSet(const Ref<DescriptorSetLayout>& layout) : m_layout(layout) {}
