...
namespace Cacao
{
    ...
    {
    public:
        D3D11TextureView(Ref<D3D11Texture> texture) : m_texture(std::move(texture)) {}
    ...
    public:
        ...
        SampleCount GetSampleCount() const override { return m_sampleCount; }
        TextureUsageFlags GetUsage() const override { return m_usage; }
